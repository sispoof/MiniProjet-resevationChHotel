...
if(!isset($_SESSION['adminUsername']))
{
    ...
    if(isset($_POST['delete']) && isset($_POST['id']))
    {
        ...
        $req = "Delete from service where id_service = '$id'";
  ...
  $db = mysqli_connect($db_host,$db_username,$db_password,$db_name) or die('Could not connect To database');
  $req = 'select id_service,title from service   ';
  $exec = mysqli_query($db,$req);
...
<h3 class="text-center font-weight-bolder text-primary" style="font-family:monospace;font-size:27px">Ajout service</h3>
<br>
<form action="actionAddService.php" method="post">
<div class="row">
<div class="col">
    <div class="form-group">
        <label for="chambreList">service</label>
...
<button class="btn btn-outline-primary" name="submit">Ajout</button>
</form>

</div>
<hr>
<div class="container mt-5">
<h3 class="text-center font-weight-bolder text-primary" style="font-family:monospace;font-size:27px">liste des services</h3>
<br>
<table class="table">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    ?>
    <tr>
            <th scope="row"><?= $ch['id_service']; ?></th>
            <td> <?= $ch['title']; ?> </td>
           
                <td>
                <form action="services.php" method="post">
                <input type="text" name="id" value="<?=$ch['id_service']; ?>" hidden>
