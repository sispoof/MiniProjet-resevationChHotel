    ...
    <li class="nav-item dropdown  ">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" href="add_ev.php">add</a>
      </li>
        <li class="nav-item">
...
<div class="container mt-5 card p-4 shadow mb-5">
    <h5 class="card-title text-center text-primary">ADD EVENT</h5>
    <hr>
    <form enctype="multipart/form-data" action="includes/actionAddEv.php" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="date" name="date_eve" class="form-control">
    </div>
