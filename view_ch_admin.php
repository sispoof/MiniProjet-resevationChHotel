  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item dropdown  ">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item active" href="view_ch_admin.php">view/delete</a>
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
            ...
            <td><?= $ch['prix']; ?></td>
            <td> <img src="<?= $ch['path']; ?>" width="50px" height="40px" alt=""> </td>
            <td> <a href="includes/actionDelete.php?id=<?= $ch['id_ch']; ?>" class="btn btn-outline-danger">delete</a> </td>
    </tr>
