...
if(!isset($_SESSION['adminUsername']))
{
  ...
  $req = 'select p.id_participation,u.id,e.id_event,u.username, e.Title,p.etat from participations p join events e on p.id_event=e.id_event
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item dropdown active ">
        ...
        <div class="dropdown-menu " aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" href="dem_participation.php">participation</a>
...
<table class="table">
  ...
  <tbody>
    ...
    ?>
    <tr>
            <th scope="row"><?= $ch['id_participation']; ?></th>
            <td> <?= $ch['id']; ?> </td>
            <td><?= $ch['id_event']; ?></td>
            <td><?= $ch['username']; ?></td>
            <td><?= $ch['Title']; ?></td>
            <td> 
              ...
              ?>
                ...
                <a href="accept_part.php?id=<?=$ch['id_participation']; ?>" class="btn btn-outline-success">Accept</a>
                <a href="refuse_part.php?id=<?=$ch['id_participation']; ?>" class="btn btn-outline-danger">Refuse</a>
